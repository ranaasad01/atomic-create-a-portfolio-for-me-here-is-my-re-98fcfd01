      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="space-y-4">
            ...
            <div className="space-y-3">
              <a
                href={`mailto:${socialLinks.email}`}
                className="flex items-center gap-3 text-slate-400 hover:text-indigo-400 text-sm transition-colors duration-200 group"
              >
                <div className="w-8 h-8 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-indigo-500/40 transition-colors duration-200">
        ...
        >
          ...
          <p className="text-slate-500 text-xs flex items-center gap-1">
            Built with <Heart className="w-3 h-3 text-indigo-400 fill-indigo-400" /> using Next.js & Framer Motion
          </p>
        </motion.div>
      </div>
    </footer>
