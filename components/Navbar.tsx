      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden bg-[#0f172a]/95 backdrop-blur-md border-b border-white/5 overflow-hidden"
          >
            <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-1">
              ...
              <div className="pt-2 pb-1">
                <Link
                  href={getLinkHref(ctaLink.href)}
                  onClick={(e) => handleAnchorClick(e, ctaLink.href)}
                  className="block w-full text-center px-4 py-3 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 text-white text-sm font-semibold shadow-lg shadow-indigo-500/25"
                >
                  {ctaLink.label}
                </Link>
              </div>
